    ...
    <div class="bg-[#0072E3] px-4 py-3 md:px-6">
      <div class="relative mx-auto flex max-w-7xl items-center justify-between gap-4">
        ...
        >
          ...
          <span
            v-if="cart.isLoading"
            class="absolute -right-2 -top-2 flex h-5 w-5 items-center justify-center"
          >
            <span class="absolute h-full w-full animate-ping rounded-full bg-yellow-400 opacity-75" />
            <span class="relative h-3 w-3 rounded-full bg-yellow-300" />
          </span>
          <span
        ...
        <div class="hidden items-center gap-5 md:flex">
          ...
          >
            ...
            <span
              v-if="cart.isLoading"
              class="absolute -right-2 -top-1 flex h-5 w-5 items-center justify-center"
            >
              <span class="absolute h-full w-full animate-ping rounded-full bg-yellow-400 opacity-75" />
              <span class="relative h-3 w-3 rounded-full bg-yellow-300" />
            </span>
