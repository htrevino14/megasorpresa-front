...
<template>
  ...
  >
    <!-- Product image -->
    <NuxtLink :to="`/product/${product.id}`" class="block overflow-hidden rounded-t-lg">
    ...
    <div class="flex flex-1 flex-col gap-2 p-3">
      <NuxtLink :to="`/product/${product.id}`" class="line-clamp-2 text-sm font-semibold text-gray-800 hover:text-yellow-500">
        {{ product.name }}
      </NuxtLink>
