 ...
 *
 * Layout de dos columnas: sidebar de navegación (≈25%) y contenedor de
 * contenido (≈75%) con los datos del perfil obtenidos de `GET /api/profile`.
 */
...
useHead({ title: 'Mi perfil · MegaSorpresa' })
